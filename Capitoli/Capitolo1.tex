...
più volte, come gli algoritmi di machine-leanring.
...
Questo tipo di  operazioni, che creano RDD, sono dette \emph{trasformazioni}. In particolare Spark offre due tipologie di operazioni:
\begin{itemize}
...
Gli RDD posssono contenere qualsiasi tipo di oggetti \footnote{poiche Spark `e eseguito su una JVM, questi elementi sono oggetti JAVA} , che sono suddivisi in
