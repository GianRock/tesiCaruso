...
Questo tipo di  operazioni, che creano RDD, sono dette \emph{trasformazioni}. In particoalre Spark offre due tipologie di operazioni:
\begin{itemize}
\item \textbf{Trasformazioni} operazioni che producono nuovi RDD a partire dau un rdd come \emph{map,filter,join}
\item \textbf{Azioni}
\end{itemize}
